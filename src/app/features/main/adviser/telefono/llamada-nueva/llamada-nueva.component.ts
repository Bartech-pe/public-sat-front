...
@Component({
  ...
  templateUrl: './llamada-nueva.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class LlamadaNuevaComponent implements OnInit {
  ...
  datosPorVista: { [key: string]: any[] } = {
    ...
    Notificaciones: [],
    Comunicaciones: [
      { fecha: '02/01/2025', tipo: 'Trámite', canal: 'Email', metodo: 'Correo', contacto: 'juan@mail.com', resultado: 'Pendiente', usuario: 'Ana', acciones: '' },
      { fecha: '02/01/2025', tipo: 'Trámite', canal: 'Email', metodo: 'Correo', contacto: 'juan@mail.com', resultado: 'Pendiente', usuario: 'Ana', acciones: '' },
      { fecha: '02/01/2025', tipo: 'Trámite', canal: 'Email', metodo: 'Correo', contacto: 'juan@mail.com', resultado: 'Pendiente', usuario: 'Ana', acciones: '' },
      { fecha: '02/01/2025', tipo: 'Trámite', canal: 'Email', metodo: 'Correo', contacto: 'juan@mail.com', resultado: 'Pendiente', usuario: 'Ana', acciones: '' },
      { fecha: '02/01/2025', tipo: 'Trámite', canal: 'Email', metodo: 'Correo', contacto: 'juan@mail.com', resultado: 'Pendiente', usuario: 'Ana', acciones: '' },
  ...
  items = [
    {
      nombre: 'Juan Pérez',
      estado: 'Activo',
      detalles: 'Llamado el 5 de agosto. Comentó que está satisfecho con el servicio.'
    },
    {
      nombre: 'Ana López',
      estado: 'Pendiente',
