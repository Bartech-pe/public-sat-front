...
export class WhatsappComponent implements OnInit, OnDestroy {
  ...
  onSubmit() {
    ...
    const cleanedForm = {
        ...
        phoneNumber: form.phoneNumber ? form.phoneNumber.replace(/\D/g, '').trim() : undefined,
    };
    if (this.id) {
  ...
  //       id: this.id,
  //       ...form,
  //       idChannel: this.channelSelected.id,
  //     });
  //   } else {
  //     this.store.create({ ...form, idChannel: this.channelSelected.id });
  //   }
  // }
}
