...
import { AMIFilter, CallDTO, EndDTO, InterferCallDTO, RecordingDTO, SpyDTO } from '@models/supervise';
...
getDownloadFilename(filename: string) {
  return this.http.get(`${this.basePath}/download/${filename}`, { responseType: 'blob' });
}
}
