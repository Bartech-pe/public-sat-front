...
import { satColors } from './sat-colors';
...
export const MyPreset = definePreset(Aura, {
  primitive: {
    ...
    colors: {
      ...
      // surface: satColors.background,
      // content: satColors.text,
      // highlight: satColors.contentCard,
    },
  },
  semantic: {
    ...
    colorScheme: {
      light: {
        ...
        primary: {
          color: `${satColors.principal}`,
          contrastColor: `${satColors.white}`,
          hoverColor: `${satColors.principalHover}`,
          activeColor: `${satColors.principalHover}`,
        },
        highlight: {
  ...
  components: {
    ...
    badge: {
      ...
      colorScheme: {
        light: {
          primary: {
            background: `${satColors.principal}`,
            color: `${satColors.white}`,
          },
          secondary: {
            background: '{surface.100}',
            color: '{surface.600}',
